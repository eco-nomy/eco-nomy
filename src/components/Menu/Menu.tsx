    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="lg:hidden z-50 px-4 py-2 bg-[var(--c-bg)] text-[var(--c-text)] rounded-md shadow-md hover:bg-[#2e7c10] transition"
            >
                Menu ▼
            </button>

            {isOpen && (
                <div className="lg:hidden absolute right-0 mt-2 w-48 bg-[var(--c-bg)] text-[var(--c-text)] rounded-md shadow-lg border border-[#414141]">
            ...
            <div className="hidden lg:flex space-x-6 bg-[var(--c-bg2)] text-[var(--c-text2)] px-6 py-3 rounded-md shadow-md">
                <Link to="/" className="hover:text-[#2e7c10] transition">Home</Link>
                <Link to="/integrantes" className="hover:text-[#2e7c10] transition">Integrantes</Link>
                <Link to="/sobre" className="hover:text-[#2e7c10] transition">Sobre</Link>
                <Link to="/perguntas" className="hover:text-[#2e7c10] transition">FAQ</Link>
