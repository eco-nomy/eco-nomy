...
export default function Contratacao() {
  ...
  useEffect(() => {
    ...
    const fetchPropostas = async () => {
      try {
        ...
        // Filtra apenas as que SÃO longo prazo
        const filtradas = data.filter((p) => p.is_longo_prazo === 1);
  ...
  return (
    <main className="p-6">
      <h1 className="text-2xl font-bold mb-4">Contratações de Longo Prazo</h1>
